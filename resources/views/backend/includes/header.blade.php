    ...
    <div class="container-fluid navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                ...
                @if (isset($is_single_business) && !$is_single_business)
                    <li class="nav-item dropdown me-0 me-xl-1 pe-3 border-end iq-dropdown">
                        <a href="javascript:void(0)" class="nav-link p-0" data-bs-toggle="dropdown">
                            @if (isset($selected_business))
                                <div class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <span class="iq-media-group">
                                            <div class="icon iq-icon-box-3 rounded-pill">
                                                {{ substr($selected_business->name, 0, 1) }}</div>
                                        </span>
                                        <div class="ms-3 flex-grow-1">
                                            <h6 class="mb-0 ">{{ $selected_business->name }}</h6>
                                        </div>
                                    </div>
                                </div>
                            @else
                                <div class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3 flex-grow-1">
                                            <h6 class="mb-0 ">{{ __('business.all_businesses') }}</h6>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                ...
                                <div class="m-0 shadow-none card">
                                    <div class="py-3 card-header d-flex justify-content-between border-bottom">
                                        <div class="header-title">
                                            <h5 class="mb-0">{{ __('messages.businesses') }}</h5>
                                        </div>
                                    </div>
                                    <div class="p-0 card-body max-17 scroll-thin">
                                        <form action="{{ route('backend.reset-business') }}" method="post">
                                            @csrf
                                            <div
                                                class="iq-sub-card {{ !isset($selected_business) ? 'bg-soft-primary' : '' }} iq-business-dropdown border-bottom">
                                                <div class="d-flex align-items-center">
                                                    <span class="iq-media-group">
                                                        <div class="icon iq-icon-box-3 rounded-pill">
                                                            {{ substr('A', 0, 1) }}
                                                    ...
                                                    <div class="ms-3 flex-grow-1">
                                                        <h6 class="mb-0 ">All Businesses</h6>
                                                    </div>
                                        ...
                                        @isset($auth_user_businesses)
                                            @foreach ($auth_user_businesses as $key => $business)
                                                <form action="{{ route('backend.set-current-business', $business->id) }}"
                                                    method="post">
                                                    @csrf
                                                    <div
                                                        class="iq-sub-card {{ isset($selected_business) && $business->id == $selected_business->id ? 'bg-soft-primary' : '' }} iq-business-dropdown border-bottom">
                                                        <div class="d-flex align-items-center">
                                                            <span class="iq-media-group">
                                                                <div class="icon iq-icon-box-3 rounded-pill">
