          ...
          <div class="col-12 row">
            ...
            <div class="form-group col-md-12">
              <div class="d-flex justify-content-between">
                <label for="manager_id">{{ $t('business.lbl_select_manager') }} <span class="text-danger">*</span></label>
              ...
              <Multiselect v-model="manager_id" :value="manager_id" :placeholder="$t('business.assign_manager')" :options="manager.options" v-bind="singleSelectOption" id="manager_id"></Multiselect>
            ...
            <div class="form-group col-md-12">
              <label class="form-label" for="services">{{ $t('business.lbl_select_service') }}</label>
              <Multiselect v-model="service_id" :value="service_id" :options="service.options" :placeholder="$t('business.select_service')" v-bind="multiselectOption" id="services"></Multiselect>
            </div>
            <div class="form-group col-md-6">
              <label class="form-label"> {{ $t('business.lbl_contact_number') }} <span class="text-danger">*</span> </label>
            ...
            <InputField class="col-md-6" :is-required="true" :label="$t('business.lbl_contact_email')" :placeholder="$t('business.enter_email')" v-model="contact_email" :error-message="errors.contact_email" :error-messages="errorMessages['contact_email']"></InputField>
            <InputField class="col-md-6" :is-required="true" :label="$t('business.lbl_shop_number')" :placeholder="$t('business.enter_landmark')" v-model="address_line_1" :error-message="errors['address.address_line_1']" :error-messages="errorMessages['address_line_1']"></InputField>
            <InputField class="col-md-6" :label="$t('business.lbl_landmark')" :placeholder="$t('business.enter_nearby')" v-model="address_line_2" :error-message="errors['address.address_line_2']" :error-messages="errorMessages['address_line_2']"></InputField>
            <div class="col-md-3 form-group">
              <label class="form-label">{{ $t('business.lbl_country') }} <span class="text-danger">*</span></label>
              <Multiselect id="country-list" v-model="country" :value="country" :placeholder="$t('business.select_country')" v-bind="singleSelectOption" :options="countries.options" @select="getState" class="form-group"></Multiselect>
            ...
            <div class="col-md-3 form-group">
              <label class="form-label">{{ $t('business.lbl_state') }} <span class="text-danger">*</span></label>
              <Multiselect id="state-list" v-model="state" :value="state" v-bind="singleSelectOption" :placeholder="$t('business.select_state')" :options="states.options" @select="getCity" class="form-group"></Multiselect>
            ...
            <div class="col-md-3 form-group">
              <label class="form-label">{{ $t('business.lbl_city') }}<span class="text-danger">*</span></label>
              <Multiselect id="city-list" v-model="city" :value="city" v-bind="singleSelectOption" :placeholder="$t('business.select_city')" :options="cities.options" class="form-group"></Multiselect>
            ...
            <InputField class="col-md-3" type="text" :is-required="true" :label="$t('business.lbl_postal_code')" :placeholder="$t('business.select_code')" v-model="postal_code" :error-message="errors['address.postal_code']" :error-messages="errorMessages['postal_code']"></InputField>
            <InputField class="col-md-3" :is-required="true" :label="$t('business.lbl_lat')" :placeholder="$t('business.enter_latitutude')" v-model="latitude" :error-message="errors['address.latitude']" :error-messages="errorMessages['latitude']"></InputField>
            <InputField class="col-md-3" :is-required="true" :label="$t('business.lbl_long')" :placeholder="$t('business.enter_logtitude')" v-model="longitude" :error-message="errors['address.longitude']" :error-messages="errorMessages['longitude']"></InputField>

            <div class="form-group col-md-6">
              <label class="form-label" for="payment-method">{{ $t('business.lbl_payment_method') }} <span class="text-danger">*</span></label>
            ...
            <div class="form-group col-md-12">
              <label class="form-label" for="description">{{ $t('business.lbl_description') }}</label>
              <textarea class="form-control" v-model="description" :placeholder="$t('business.enter_decription')" id="description"></textarea>
            ...
            <div class="form-group col-md-2">
              <div class="d-flex gap-3">
                <label class="form-label" for="category-status">{{ $t('business.lbl_status') }}</label>
...
import { EDIT_URL, STORE_URL, UPDATE_URL, SERVICE_LIST, EMPLOYEE_LIST, COUNTRY_URL, STATE_URL, CITY_URL } from '../../constants/business'
...
const PAYMENT_METHODS_OPTIONS = reactive(parseSelectData['PAYMENT_METHODS'].filter((method) => method.id !== 'razorpay'))
