<template>
  <form @submit="formSubmit">
    ...
    <div class="row">
      ...
      <InputField class="col-md-6" :is-required="false" :label="$t('business.lbl_shop_number')" placeholder="" v-model="bussiness_address_line_1"></InputField>
      <InputField class="col-md-6" :is-required="false" :label="$t('business.lbl_landmark')" placeholder="" v-model="bussiness_address_line_2"></InputField>
      <InputField class="col-md-2" :is-required="false" :label="$t('business.lbl_country')" placeholder="" v-model="bussiness_address_country"></InputField>
      <InputField class="col-md-2" :is-required="false" :label="$t('business.lbl_state')" placeholder="" v-model="bussiness_address_state"></InputField>
      <InputField class="col-md-2" :is-required="false" :label="$t('business.lbl_city')" placeholder="" v-model="bussiness_address_city"></InputField>
      <InputField class="col-md-2" :is-required="false" :label="$t('business.lbl_postal_code')" placeholder="" v-model="bussiness_address_postal_code"></InputField>
      <InputField class="col-md-2" :is-required="false" :label="$t('business.lbl_lat')" placeholder="" v-model="bussiness_address_latitude"></InputField>
      <InputField class="col-md-2" :is-required="false" :label="$t('business.lbl_long')" placeholder="" v-model="bussiness_address_longitude"></InputField>
    </div>
