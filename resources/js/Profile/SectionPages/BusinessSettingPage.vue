<template>
  <form @submit="formSubmit">
    <div class="d-flex justify-content-between align-items-center">
      <CardTitle title="Business Setting" icon="fa-solid fa-code-business"></CardTitle>
    </div>
    <div class="row">
      <div class="col-12 row">
        <div class="d-flex align-items-center">
          <div class="col-6">
            <InputField :is-required="true" :label="$t('business.lbl_business_name')" placeholder="" v-model="name" :error-message="errors.name"></InputField>
            <div class="form-group">
              <label class="form-label">{{ $t('business.lbl_business_for') }}</label>
              <div class="btn-group w-100" role="group" aria-label="Basic example">
                <template v-for="(item, index) in BUSINESS_FOR_OPTIONS" :key="index">
        ...
        <InputField class="col-md-6" :is-required="true" :label="$t('business.lbl_contact_email')" placeholder="" v-model="contact_email" :error-message="errors.contact_email"></InputField>
        <InputField class="col-md-6" :is-required="true" :label="$t('business.lbl_shop_number')" placeholder="" v-model="address_line_1" :error-message="errors['address.address_line_1']"></InputField>
        <InputField class="col-md-6" :label="$t('business.lbl_landmark')" placeholder="" v-model="address_line_2" :error-message="errors['address.address_line_2']"></InputField>
        <InputField class="col-md-2" :is-required="true" :label="$t('business.lbl_country')" placeholder="" v-model="country" :error-message="errors['address.country']"></InputField>
        <InputField class="col-md-2" :is-required="true" :label="$t('business.lbl_state')" placeholder="" v-model="state" :error-message="errors['address.state']"></InputField>
        <InputField class="col-md-2" :is-required="true" :label="$t('business.lbl_city')" placeholder="" v-model="city" :error-message="errors['address.city']"></InputField>
        <InputField class="col-md-2" type="number" :is-required="true" :label="$t('business.lbl_postal_code')" placeholder="" v-model="postal_code" :error-message="errors['address.postal_code']"></InputField>
        <InputField class="col-md-2" :is-required="true" :label="$t('business.lbl_lat')" placeholder="" v-model="latitude" :error-message="errors['address.latitude']"></InputField>
        <InputField class="col-md-2" :is-required="true" :label="$t('business.lbl_long')" placeholder="" v-model="longitude" :error-message="errors['address.longitude']"></InputField>
        ...
        <!-- <div class="form-group col-md-6">
              <label class="form-label" for="feature_image">{{ $t('business.lbl_feature_image') }}</label>
...
import { UPDATE_BUSINESS_SETTING, SERVICE_LIST, GET_URL } from '@/vue/constants/business'
...
const BUSINESS_FOR_OPTIONS = reactive([
...
const formSubmit = handleSubmit((values) => {
  ...
  storeRequest({ url: UPDATE_BUSINESS_SETTING, body: values, type: 'file' }).then((res) => display_submit_message(res))
})
</script>
