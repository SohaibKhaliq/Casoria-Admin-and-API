...
class BookingsController extends Controller
{
    ...
    public function index_data(Datatables $datatable, Request $request)
    {
        ...
        $query = Booking::with('business', 'user', 'services', 'mainServices', 'payment', 'bookingPackages', 'bookedPackageService', 'userPackageServices');
    ...
    public function bulk_action(Request $request)
    {
        ...
        switch ($actionType) {
            case 'change-status':
                $businesses = Booking::whereIn('id', $ids)->update(['status' => $request->status]);
    ...
    public function booking_slots(Request $request)
    {
        ...
        $slots = $this->getSlots($request->date, $day, $business_id);
    ...
    public function payment_create(Request $request)
    {
        ...
        $payment_methods = $booking->business->payment_method;
