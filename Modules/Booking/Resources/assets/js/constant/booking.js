...
export const EMPLOYEE_LIST = ({ business_id, show_in_calender = 1 }) => { return { path: ` employees/employee_list?business_id=${business_id}&show_in_calender=${show_in_calender}`, method: 'GET' } }
export const SERVICE_LIST = ({ id: employee_id, business_id }) => { return { path: `${MODULE}/services-index_list?employee_id=${employee_id}&business_id=${business_id}`, method: 'GET' } }
export const SLOT_LIST = ({ date, business_id }) => { return { path: `${MODULE}/slots?date=${date}&business_id=${business_id}`, method: 'GET', } }
...
// Package Module
export const PACKAGE_LIST = ({ business_id }) => { return { path: `package/index_list?business_id=${business_id}`, method: 'GET' } };
