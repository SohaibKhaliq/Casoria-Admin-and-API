            ...
            <div class="card mb-4" id="section-1">
                <div class="card-body">
                    ...
                    <div class="row justify-content-between align-items-center g-3 mb-4">
                        ...
                        <div class="col-auto text-end">
                            <h5 class="mb-0">{{ __('booking.download_invoice') }}
                                <span class="text-accent">{{ setting('inv_prefix') }}{{ $data->booking->resource->id }}
                                </span>
                            </h5>
                    ...
                    <div class="d-flex justify-content-md-between justify-content-center g-3">
                        ...
                        <div class="col-auto">
                            @php
                                $business = optional($data->booking->resource->business);
                            ...
                            @if ($business)
                                <div class="shipping-address d-flex justify-content-md-end gap-3 mb-3"
                                    ...
                                    <div class="w-25">
                                        <h5 class="mb-2">{{ __('booking.business_name') }}</h5>
                ...
                <table class="table table-bordered border-top" data-use-parent-width="true">
                    ...
                    <tfoot class="text-end">
                        <tr>
                            ...
                            <td width="10%">
                                <strong>{{ \Currency::format($data->services_total_amount + $productPrice + $data->package_amount) }}</strong>
                            </td>
                        </tr>
                        <tr>
