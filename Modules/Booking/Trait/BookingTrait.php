...
trait BookingTrait
{
    ...
    protected function sendNotificationOnBookingUpdate($type, $notify_message, $booking, $notify = true)
    {
        ...
        $address = [
            'address_line_1' => $booking->business->address->address_line_1,
            'address_line_2' => $booking->business->address->address_line_2,
            'city' => $booking->business->address->city,
            'state' => $booking->business->address->state,
            'country' => $booking->business->address->country,
            'postal_code' => $booking->business->address->postal_code,
        ];
        ...
        $data['booking'] = [
            ...
            'employee_id' => $booking->business->employee->id,
