...
@section('content')
            ...
            <x-backend.section-header>
                ...
                <x-slot name="toolbar">
                    ...
                    @hasPermission('add_staff')
                        <x-buttons.offcanvas target='#form-offcanvas' title="">{{ __('messages.new') }}
                        </x-buttons.offcanvas>
                    @endhasPermission
                </x-slot>
            </x-backend.section-header>
    ...
    <div data-render="app" class="{{ $selected_business_id }}">
        <employee-offcanvas
            :selected-session-business-id="{{ $selected_business_id !== '' ? $selected_business_id : null }}"
