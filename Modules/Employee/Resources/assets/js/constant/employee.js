...
export const SERVICE_LIST = ({ business_id = '', category_id = '', employee_id = '' }) => {
  return { path: `service/index_list?business_id=${business_id}&employee_id=${employee_id}&category_id=${category_id}`, method: 'GET' }
}
