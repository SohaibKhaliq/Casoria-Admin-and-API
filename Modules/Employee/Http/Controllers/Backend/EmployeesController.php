...
class EmployeesController extends Controller
{
    ...
    public function index_list(Request $request)
    {
        ...
        $query_data = Business::where('status', 1)
    ...
    public function employee_list(Request $request)
    {
        ...
        $query_data = User::role('employee')->with('media', 'businesses')->where(function ($q) use ($term) {
            if (!empty($term)) {
        ...
        if (isset($businessId) && !empty($businessId)) {
            $query_data->whereHas('businesses', function ($q) use ($businessId) {
    ...
    public function bulk_action(Request $request)
    {
        ...
        switch ($actionType) {
            ...
            case 'delete':
                ...
                BusinessEmployee::whereIn('employee_id', $ids)->delete();
    ...
    {
        $module_name = $this->module_name;
        $query = User::select('users.*')->role(['employee', 'manager'])->business()->with('media', 'mainBusiness');
        ...
        $datatable = $datatable->eloquent($query)
            ...
            ->addColumn('business_id', function ($data) {
                return optional($data->mainBusiness)->pluck('name')->toArray() ?? '-';
            })
    ...
    public function store(EmployeeRequest $request)
    {
        ...
        if ($request->is_manager) {
            ...
            if ($request->has('business_id')) {
                ...
                $business->update(['manager_id' => $employee_id]);
            }
        }
        ...
        if ($request->has('business_id')) {
            ...
            BusinessEmployee::create($business_data);
        }
    ...
    {
        $data = User::role('employee')->with('businesses', 'services', 'commissions', 'profile')->findOrFail($id);
        if (!is_null($data)) {
        ...
        $data['business_id'] = $data->business->business_id ?? null;
    ...
    public function update(EmployeeRequest $request, $id)
    {
        ...
        BusinessEmployee::where('employee_id', $id)->delete();
