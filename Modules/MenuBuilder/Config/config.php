...
return [
    ...
    'ARRAY_MENU' => [
        ...
        [
            ...
            'menu_item_type' => 'static',
            'permission' => ['booking_booking_tableview', 'view_business', 'view_service'],
            'order' => 3,
        ],
        [
            'start_icon' => 'fa-solid fa-code-business',
            'title' => 'sidebar.businesses',
            'route' => 'backend.business.index',
            'active' => ['app/business'],
