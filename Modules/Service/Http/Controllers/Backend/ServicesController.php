...
class ServicesController extends Controller
{
    ...
    public function index_list(Request $request)
    {
        ...
        $data = Service::with('employee', 'businesses');
        ...
        if (isset($business_id)) {
            $data = $data->whereHas('businesses', function ($q) use ($business_id) {
    ...
    public function index_data(Datatables $datatable, Request $request)
    {
        ...
        $datatable = $datatable->eloquent($query)
            ...
            ->editColumn('name', function ($data) {
                return view('backend.business.business_id', compact('data'));
            })
        ...
        if (!request()->is_single_business) {
            $datatable->editColumn('businesses_count', function ($data) {
                return "<b>$data->businesses_count</b>  <button type='button' data-assign-module='" . $data->id . "' data-assign-target='#service-business-assign-form' data-assign-event='business_assign' class='btn btn-primary btn-sm rounded text-nowrap ' data-bs-toggle='tooltip' title=" . __('business.assign_business_to_service') . "><i class='fa-solid fa-plus p-0'></i></button>";
            });
        }
        ...
        return $datatable->rawColumns(array_merge(['action', 'image', 'status', 'check', 'businesses_count', 'employee_count'], $customFieldColumns))
            ->toJson();
    }
    ...
    public function update(ServiceRequest $request, $id)
    {
        ...
        if ($data->default_price !== floatval($request_data['default_price'])) {
            ServiceBusinesses::where('service_id', $id)->update(['service_price' => $data->default_price]);
        }
        if ($data->duration_min !== $request_data['duration_min']) {
            ServiceBusinesses::where('service_id', $id)->update(['duration_min' => $data->duration_min]);
        }
    ...
    public function assign_business_list($id)
    {
        ...
        return response()->json(['status' => true, 'data' => $service_business]);
    }
    ...
    public function assign_business_update($id, Request $request)
    {
        ...
        return response()->json(['status' => true, 'message' => __('messages.service_business_update')]);
    }
