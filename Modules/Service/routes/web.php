...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth']], function () {
    ...
    */
    ...
    Route::group(['prefix' => 'services', 'as' => 'services.'], function () {
        ...
        // Assign Business
        Route::get('/assign-business/{id}', [ServicesController::class, 'assign_business_list'])->name('assign_business_list');
        Route::post('/assign-business/{id}', [ServicesController::class, 'assign_business_update'])->name('assign_business_update');
