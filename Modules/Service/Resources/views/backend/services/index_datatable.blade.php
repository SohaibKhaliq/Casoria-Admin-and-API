...
@section('content')
    ...
    <div data-render="app">
        <service-form-offcanvas default-image="{{ default_feature_image() }}"
            create-title="{{ __('messages.new') }} {{ __('service.singular_title') }}"
        ...
        <assign-business-form-offcanvas></assign-business-form-offcanvas>
            ...
            @if (!$is_single_business)
                {
                    ...
                    title: "{{ __('service.lbl_businesses') }}",
                    orderable: true,
                    searchable: false,
                },
            @endif
