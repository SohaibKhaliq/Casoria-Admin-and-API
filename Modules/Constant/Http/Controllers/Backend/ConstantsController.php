...
class ConstantsController extends Controller
{
    ...
    public function bulk_action(Request $request)
    {
        ...
        switch ($actionType) {
            case 'change-status':
                $businesses = Constant::whereIn('id', $ids)->update(['status' => $request->status]);
    ...
    public function index_data(Datatables $datatable, Request $request)
    {
        ...
        return $datatable->rawColumns(array_merge(['action', 'status', 'business_for', 'check'], $customFieldColumns))
            ->toJson();
    }
