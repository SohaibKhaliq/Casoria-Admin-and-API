        ...
        <div class="row">
          <div class="col-12 py-2">
            <div class="form-group">
              ...
              <Multiselect id="payment_method" v-model="payment_method" :placeholder="$t('earning.select_method')" v-bind="singleSelectOption" :options="payment_method_data.options" @select="businessSelect" class="form-group"></Multiselect>
