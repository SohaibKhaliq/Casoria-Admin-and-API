...
class PackagesController extends Controller
{
    ...
    public function index_list(Request $request)
    {
        ...
        // $query_data = Package::with('service.services','business')->get();
        $businessId = $request->get('business_id');

        // Query the packages with or without filtering by business
        $query_data = Package::with('service.services', 'business')
    ...
    {
        $query_data = UserPackage::with('userPackageServices.packageService.services', 'package.business', 'bookingTransaction')->where('user_id', $user_id)->get();
    ...
    public function services_index_list(Request $request)
    {
        ...
        $data = Service::select('services.name as service_name', 'service_businesses.*')
            ->with('employee')
            ->leftJoin('service_businesses', 'service_businesses.service_id', 'services.id')
