...
const validationSchema = yup.object({
  ...
  business_id: yup.string().required('Business is a required field'),
...
const businessSelect = () => {
  useSelect({ url: EMPLOYEE_LIST, data: { business_id: business_id.value } }, { value: 'id', label: 'name' }).then((data) => (employee.value = data))
  useSelect({ url: SERVICE_LIST, data: { business_id: business_id.value } }, { value: 'service_id', label: 'service_name' }).then((data) => (serviceList.value = data))
}
