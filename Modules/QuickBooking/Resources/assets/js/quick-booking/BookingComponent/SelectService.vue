<template>
  <div class="card-list-data">
    ...
    <div v-else-if="serviceList.length == 0 && !IS_LOADER" class="h-100 w-75 d-flex align-items-center justify-content-center">We apologize for any inconvenience caused. Unfortunately, the selected salon business does not offer the service you are looking for at the moment.</div>
  </div>
...
const getBusiness = () => {
  ...
  if (store.booking.business_id !== null || store.booking.category_id !== null) {
