            ...
            <div class="iq-card-body">
              <table class="iq-table-border mb-0" style="border: 0">
                <tbody>
                  <tr>
                    <td>
                      <h6 style="width: 15em" class="mb-2">{{ booking.business.name }}</h6>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <p style="width: 15em" class="mb-2">{{ booking.business_address.country }} / {{ booking.business_address.postal_code }}</p>
                    </td>
                  </tr>
                </tbody>
              </table>
