...
class UserDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        $datatable = (new EloquentDataTable($query))
            ...
            ->addColumn('assign', function ($data) {
                return "<b>$data->business_employee_count</b> <button type='button' data-assign-module='$data->id' data-assign-target='#staff-assign-form' data-assign-event='staff_assign' class='btn btn-primary btn-sm rounded btn-icon'><i class='fa-solid fa-plus'></i></button>";
            })
        ...
        return $datatable->rawColumns(array_merge(['action', 'status', 'business_for', 'check', 'image', 'assign'], $customFieldColumns));
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            ['data' => 'image', 'name' => 'image', 'title' => __('business.lbl_image'), 'orderable' => false, 'printable' => false, 'exportable' => false],
            ['data' => 'name', 'name' => 'name', 'title' => __('business.lbl_name'), 'width' => '15%'],
            ['data' => 'contact_number', 'name' => 'contact_number', 'title' => __('business.lbl_contact_number'), 'width' => '15%'],
            ['data' => 'manager_id', 'name' => 'manager_id', 'title' => __('business.lbl_manager_name'), 'width' => '15%'],
            ['data' => 'address.city', 'name' => 'address.city', 'title' => __('business.lbl_city'), 'width' => '15%'],
            ['data' => 'address.postal_code', 'name' => 'address.postal_code', 'title' => __('business.lbl_postal_code'), 'width' => '10%'],
            ['data' => 'assign', 'name' => 'assign', 'title' => 'Assign', 'orderable' => false, 'searchable' => false, 'printable' => false],
            ['data' => 'business_for', 'name' => 'business_for', 'title' => __('business.lbl_business_for'), 'width' => '12%', 'printable' => false],
            ['data' => 'status', 'name' => 'status', 'title' => __('business.lbl_status'), 'width' => '5%', 'printable' => false],
        ];
    }
